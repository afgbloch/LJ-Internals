...
\thesistitle{First Performance Analysis of MAD-NG Embedded Tracing JIT Compiler} % title
\authors{
...
\label{Part:mad}
  ...
  \lhead{Chapter \thechapter. \emph{Introduction}}
    ...
    \section{MAD}
    \label{Sec:mad}
    \input{./Tex/Part-I/Chap-I/mad}

    \section{Lua ... JIT}
    \label{Sec:LuaJIT}
    \input{./Tex/Part-I/Chap-I/luajit-intro}

    \section{Problem description}
    \label{Sec:Problem-description}
    \input{./Tex/Part-I/Chap-I/Problem-description}

  \chapter{Object Model}
  \label{Chapt:MO}
  \lhead{Chapter \thechapter. \emph{Object Model}}
  \input{./Tex/Part-I/Chap-II/MO.tex}

    \section{Description}
    \label{Sec:MO-descriptinon}
    \input{./Tex/Part-I/Chap-II/MO-Description.tex}

    \section{Performance analysis}
    \label{Sec:MO-perf-analys}
    \input{./Tex/Part-I/Chap-II/MO-perf.tex}

    \section{Possible explanations for performance hit}
    \label{Sec:MO-insta}
    \input{./Tex/Part-I/Chap-II/MO-insta.tex}

    \section{Performance of \emph{Sequence} iterator}
    \label{Sec:MO-perf-iter}
    \input{./Tex/Part-I/Chap-II/MO-perf-iter.tex}

    \section{Alternative design of the model object}
    \label{Sec:MO-alt-design}
    \input{./Tex/Part-I/Chap-II/MO-alt-design.tex}
...
\label{Part:luajit-doc}
  ...
  \lhead{Chapter \thechapter. \emph{Virtual Machine}}
    ...
    \section{Frontend}
    \label{Sec:frontend}
    \input{./Tex/Part-II/Chap-I/Frontend}

    \section{Internals}
    \label{Sec:Internals}
    \input{./Tex/Part-II/Chap-I/Internals}

    \section{Bytecode interpreter}
    \label{Sec:BI}
    \input{./Tex/Part-II/Chap-I/Bytecode-interpreter}

    \section{Library}
    \label{Sec:Library}
    \input{./Tex/Part-II/Chap-I/Library}

    \section{Foreign function interface}
    \label{Sec:FFI}
    \input{./Tex/Part-II/Chap-I/FFI}
  ...
  \lhead{Chapter \thechapter. \emph{JIT}}
    ...
    \label{Sec:TR}
    \input{./Tex/Part-II/Chap-II/TR.tex}

    \section{Trace optimizer}
    \label{Sec:TO}
    \input{./Tex/Part-II/Chap-II/TO.tex}

    \section{Assembler}
    \label{Sec:TA}
    \input{./Tex/Part-II/Chap-II/TA.tex}

  \chapter{Tool}
  \label{Chapt:Tool}
  \lhead{Chapter \thechapter. \emph{Tool}}
  \input{./Tex/Part-II/Chap-III/tool}

    \section{Verbose mode}
    \label{Sec:Verbose}
    \input{./Tex/Part-II/Chap-III/verbose}

    \section{Profiler}
    \label{Sec:Profiler}
    \input{./Tex/Part-II/Chap-III/profiler}

    \section{Dump mode}
    \label{Sec:Dump-mode}
    \input{./Tex/Part-II/Chap-III/dump}

    \section{Valgrind}
    \label{Sec:Valgrind}
    \input{./Tex/Part-II/Chap-III/valgrind}
