...
\authors{
  Student: A. \textsc{Bloch}\\
  Supervisor: L. \textsc{Deniau}\\
  EPFL supervisor: M. \textsc{Odersky}
}
...
\label{Part:luajit-doc}
  ...
  \label{Chapt:Tools}
    ...
    \input{./Tex/Part-II/Chap-I/verbose}

    \section{Profiler}
    \label{Sec:Profiler}
    \lhead{Chapter \thechapter. \emph{Profiler}}
    \input{./Tex/Part-II/Chap-I/profiler}

    \section{Dump mode}
    \label{Sec:Dump-mode}
    \lhead{Chapter \thechapter. \emph{Dump mode}}
    \input{./Tex/Part-II/Chap-I/dump}

    \section{Valgrind}
    \label{Sec:Valgrind}
    \lhead{Chapter \thechapter. \emph{Valgrind}}
    \input{./Tex/Part-II/Chap-I/valgrind}
  ...
  \label{Chapt:JIT}
    ...
    \label{Sec:TR}
    \input{./Tex/Part-II/Chap-III/TR.tex}

    \section{Trace optimizer}
    \label{Sec:TO}
    \input{./Tex/Part-II/Chap-III/TO.tex}

    \section{Assembler}
    \label{Sec:TA}
    \input{./Tex/Part-II/Chap-III/TA.tex}
%--------------------------------------------------------------------------------
