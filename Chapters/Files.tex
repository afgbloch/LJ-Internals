...
\paratitle{dynasm/*:}\\
All files in this folder correspond to the Dynamic Assembler (see Chapter \ref{Chapt:DynASM})\\
...
LuaJIT compiler dump module (see Section \ref{Sec:Dump-mode}).\\
\paratitle{src/jit/p.lua:}\\
LuaJIT profiler (see Section \ref{Sec:Profiler}).\\
\paratitle{src/jit/v.lua:}\\
LuaJIT verbose mode (see Section \ref{Sec:Verbose}).\\
\paratitle{src/jit/zone.lua:}\\
This module implements a simple hierarchical zone model
(See \emph{zone} in Section \ref{Sec:Profiler}).\\
...
Lua c api (e.g. stack handling etc)\\
...
\paratitle{src/lj\_bc.c:}\\
\paratitle{src/lj\_bc.h:}\\
...
\paratitle{src/lj\_carith.c:}\\
\paratitle{src/lj\_carith.h:}\\
\paratitle{src/lj\_ccall.c:}\\
\paratitle{src/lj\_ccall.h:}\\
\paratitle{src/lj\_ccallback.c:}\\
\paratitle{src/lj\_ccallback.h:}\\
\paratitle{src/lj\_cconv.c:}\\
\paratitle{src/lj\_cconv.h:}\\
\paratitle{src/lj\_cdata.c:}\\
\paratitle{src/lj\_cdata.h:}\\
\paratitle{src/lj\_char.c:}\\
\paratitle{src/lj\_char.h:}\\
\paratitle{src/lj\_clib.c:}\\
\paratitle{src/lj\_clib.h:}\\
\paratitle{src/lj\_cparse.c:}\\
\paratitle{src/lj\_cparse.h:}\\
\paratitle{src/lj\_crecord.c:}\\
\paratitle{src/lj\_crecord.h:}\\
\paratitle{src/lj\_ctype.c:}\\
\paratitle{src/lj\_ctype.h:}\\
...
\paratitle{src/lj\_func.c:}\\
\paratitle{src/lj\_func.h:}\\
\paratitle{src/lj\_gc.c:}\\
\paratitle{src/lj\_gc.h:}\\
...
\paratitle{src/lj\_opt\_dce.c:}\\
\paratitle{src/lj\_opt\_fold.c:}\\
\paratitle{src/lj\_opt\_loop.c:}\\
\paratitle{src/lj\_opt\_mem.c:}\\
\paratitle{src/lj\_opt\_narrow.c:}\\
\paratitle{src/lj\_opt\_sink.c:}\\
\paratitle{src/lj\_opt\_split.c:}\\
\paratitle{src/lj\_parse.c:}\\
\paratitle{src/lj\_parse.h:}\\
\paratitle{src/lj\_profile.c:}\\
\paratitle{src/lj\_profile.h:}\\
\paratitle{src/lj\_record.c:}\\
\paratitle{src/lj\_record.h:}\\
\paratitle{src/lj\_snap.c:}\\
\paratitle{src/lj\_snap.h:}\\
\paratitle{src/lj\_state.c:}\\
\paratitle{src/lj\_state.h:}\\
\paratitle{src/lj\_str.c:}\\
\paratitle{src/lj\_str.h:}\\
...
\paratitle{src/lj\_trace.c:}\\
\paratitle{src/lj\_trace.h:}\\
